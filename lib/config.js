...
function loadConfig(configPath) {
  try {
    ...
    const ignoreTargetPlayState = config.ignoreTargetPlayState !== undefined ? config.ignoreTargetPlayState : false;
    const initialFullSync = config.initialFullSync !== undefined ? config.initialFullSync : true;
