 ...
 */
async function syncItemToTarget(sourceItem, targetUsername, targetServer, config) {
  try {
    // Get target user
    ...
    if (!config.ignoreTargetPlayState && (targetLastPlayed > sourceLastPlayed)) {
      ...
      for (const library of libraries) {
        ...
        for (const item of items) {
          for (const targetServer of targetServers) {
            ...
            const result = await syncItemToTarget(item, targetUsername, targetServer, config);
